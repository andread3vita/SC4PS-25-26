...
define(<CONFIG_TOP_SRCDIR>,<`/afs/cern.ch/user/a/adevita/public/Renzi/SC4PS-25-26/HW5/.mpfr-build/sources/gmp-6.3.0'>)
...
define_not_for_expansion(`HAVE_HOST_CPU_zen4')
